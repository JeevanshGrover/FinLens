  ...
  return (
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        ...
        {/* Top Spending */}
        <div className="rounded-2xl border border-(--color-muted) bg-(--color-surface) p-4 shadow-[0_2px_8px_rgba(0,0,0,0.05)] transition duration-200 hover:-translate-y-px">
          <p className="text-sm text-[color-mix(in_srgb,var(--color-text)_70%,transparent)]">Top Spending</p>
          <h3 className="text-lg font-semibold mt-1">
            {topCategory ? topCategory.category : "N/A"}
          </h3>
          <p className="text-sm mt-1 text-(--color-danger)">
